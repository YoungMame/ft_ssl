...
def build_file_test(test_file, key, iv):
    return ["./ft_ssl", "des-cbc", "-i", test_file, "-k", key, "-v", iv], \
           ["openssl", "des-cbc", "-in", test_file, "-K", key, "-iv", iv, "-provider", "default", "-provider", "legacy"]

def build_out_file_test(test_file, test_out_file, key, iv):
    return ["./ft_ssl", "des-cbc", "-i", test_file, "-o", test_out_file + "_ft_ssl", "-k", key, "-v", iv], \
           ["openssl", "des-cbc", "-in", test_file, "-out", test_out_file + "_openssl", "-K", key, "-iv", iv, "-provider", "default", "-provider", "legacy"]

def build_encode_decode_cross_test(test_file, test_out_file, test_decrypted_file, key, iv):
    return ["./ft_ssl", "des-cbc", "-i", test_file, "-o", test_out_file + "_ft_ssl", "-k", key, "-v", iv], \
           ["openssl", "des-cbc", "-in", test_file, "-out", test_out_file + "_openssl", "-K", key, "-iv", iv, "-provider", "default", "-provider", "legacy"], \
           ["./ft_ssl", "des-cbc", "-d", "-i", test_out_file + "_openssl", "-o", test_decrypted_file + "_ft_ssl", "-k", key, "-v", iv], \
           ["openssl", "des-cbc", "-d", "-in", test_out_file + "_ft_ssl", "-out", test_decrypted_file + "_openssl", "-K", key, "-iv", iv, "-provider", "default", "-provider", "legacy"]

file_tests = [
    # [ "test/files/binary", "0C871EEA3AF7AAAA" ],
    [ "test/files/text", "0C871EEA3AF7AAAA", "0C871EEA3AF7AAAA" ],
    [ "test/files/image.png", "0C871EEA3AF7AAAA", "0C871EEA3AF7AAAA" ],
    [ "test/files/text", "0C871EEA3AF7AAAA", "0000000000000000" ],
    [ "test/files/text", "0C871EEA3AF7AAAA", "4242424242424242" ],
    [ "test/files/text", "4242424242424242", "0000000000000000" ],
    [ "test/files/text", "4242424242424242", "FFFFFFFFFFFFFFFF" ],
]

out_file_tests = [
    [ "test/files/text", "test/files/.out/des_ecb_test_output_text", "0C871EEA3AF7AAAA", "0C871EEA3AF7AAAA" ],
    [ "test/files/binary", "test/files/.out/des_ecb_test_output_binary", "0C871EEA3AF7AAAA", "0C871EEA3AF7AAAA" ],
    [ "test/files/image.png", "test/files/.out/des_ecb_test_output_image.png", "0C871EEA3AF7AAAA", "0000000000000000" ],
]

encode_decode_cross_tests = [
    [ "test/files/text", "test/files/.out/text.encrypted", "test/files/.out/text.decrypted","0C871EEA3AF7AAAA", "0C871EEA3AF7AAAA" ],
    [ "test/files/binary", "test/files/.out/binary.encrypted", "test/files/.out/binary.decrypted","0C871EEA3AF7AAAA", "0C871EEA3AF7AAAA" ],
    [ "test/files/image.png", "test/files/.out/image.png.encrypted", "test/files/.out/image.png.decrypted","0C871EEA3AF7AAAA", "0C871EEA3AF7AAAA" ],
]
